...
- [ ] O `motivo_reprovacao` (coluna definida em [02-modelo-dados.md](02-modelo-dados.md)) é preenchido com a regra específica que disparou a reprovação, permitindo auditoria.
